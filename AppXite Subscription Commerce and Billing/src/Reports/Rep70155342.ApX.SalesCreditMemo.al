report 70155342 "ApX Sales Credit Memo"
{
    // version NAVNA11.00

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep70155342.ApX.SalesCreditMemo.rdlc';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ReThinkBillingLine2.SETRANGE(ReThinkBillingLine2."NAV Doc Line No", "Sales Cr.Memo Line"."Line No.");
                    IF ReThinkBillingLine2.FINDFIRST THEN BEGIN
                        ...
                        IF TempReThinkBillingLine.ISEMPTY THEN BEGIN
                            ...
                            ReThinkBillingLine.SETRANGE("NAV Doc No", ReThinkBillingLine2."NAV Doc No");
                            ReThinkBillingLine.SETRANGE(customerOrg, ReThinkBillingLine2.customerOrg);
                            ReThinkBillingLine.CALCSUMS(totalPrice);
                ...
                begin
                    ...
                    ReThinkBillingLine2.SETRANGE("NAV Doc No", "Sales Cr.Memo Header"."No.");
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(SalesHeader_DocumentDate; FORMAT("Sales Cr.Memo Header"."Document Date"))
                    {
                    }
                    column(SalesHeader_DueDate; "Sales Cr.Memo Header"."Due Date")
                    {
                    }
                    ...
                    column(Amount_SalesInvHeader; "Sales Cr.Memo Header".Amount)
                    {
                    }
                    column(AmountIncludingVAT_SalesInvHeader; "Sales Cr.Memo Header"."Amount Including VAT")
                    {
                    }
                    column(InvoiceDiscountAmount_SalesInvHeader; "Sales Cr.Memo Header"."Invoice Discount Amount")
                    {
                    }
                    column(YourReference_SalesInvHeader; "Sales Cr.Memo Header"."Your Reference")
                    {
                    }
                    ...
                    column(BilltoCustNo_SalesHeader; "Sales Cr.Memo Header"."Bill-to Customer No.")
                    {
                    }
                    column(ExtDocNo_SalesHeader; "Sales Cr.Memo Header"."External Document No.")
                    {
                    }
                    column(SalesPurchPersonName; SalesPurchPerson.Name)
                    {
                    }
                    column(OrderDate_SalesHeader; "Sales Cr.Memo Header"."Document Date")
                    {
                    }
                        ...
                        dataitem(Product; Integer)
                        {
                            ...
                            dataitem(Subscription; Integer)
                            {
                                ...
                                begin
                                    ...
                                    TempReThinkBillingLine3.RESET;
                                    TempReThinkBillingLine3.SETCURRENTKEY(customerOrg, ProductName, ShortOfferName);
                                    TempReThinkBillingLine3.SETRANGE(customerOrg, TempReThinkBillingLine2.customerOrg);
                                    TempReThinkBillingLine3.SETRANGE(ProductName, TempReThinkBillingLine2.ProductName);
                            ...
                            begin
                                TempReThinkBillingLine2.RESET;
                                TempReThinkBillingLine2.SETRANGE(customerOrg, TempReThinkBillingLine.customerOrg);
                    ...
                    dataitem(TotalEndCustomer; Integer)
                    {
                        ...
                        column(TotalEndCustomer_VATNumber; VATPercentage * TempReThinkBillingLine.totalPrice / 100)
                        {
                        }
            ...
            begin
                ...
                FOR i := 1 TO 4 DO BEGIN
                    IF i = 1 THEN
                        CustDate[i] := CALCDATE('<CD-4M>', "Sales Cr.Memo Header"."Posting Date")
                    ELSE
                ...
                tempdata[1] := "Sales Cr.Memo Header"."Sell-to Customer Name";
                tempdata[2] := "Sales Cr.Memo Header"."Sell-to Customer Name 2";
                tempdata[3] := "Sales Cr.Memo Header"."Sell-to Contact";
                ...
                FormatAddress.SalesCrMemoSellTo(BillToAddress, "Sales Cr.Memo Header");
                //restore data
                "Sales Cr.Memo Header"."Sell-to Customer Name" := tempdata[1];
                "Sales Cr.Memo Header"."Sell-to Customer Name 2" := tempdata[2];
                "Sales Cr.Memo Header"."Sell-to Contact" := tempdata[3];
    ...
    var
        ...
        YourAppXiteBillCaptionLbl: Label 'Your %1 Credit Memo No:';
