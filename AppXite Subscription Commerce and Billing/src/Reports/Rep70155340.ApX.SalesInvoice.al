report 70155340 "ApX Sales Invoice"
{
    // version NAVNA11.00

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep70155340.ApX.SalesInvoice.rdlc';
    Caption = 'Sales Invoice AppXite';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            RequestFilterHeading = 'Sales Invoice AppXite';
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    ReThinkBillingLine2.SETRANGE("NAV Doc No", "Sales Header"."No.");
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(DocumentDateCaptionLbl; STRSUBSTNO(DocumentDateCaptionLbl, "Sales Header"."Document Type"))
                    {
                    }
                    column(SalesHeader_DocumentDate; FORMAT("Sales Header"."Document Date"))
                    {
                    }
                    ...
                    column(DocumentNoCaptionLbl; STRSUBSTNO(DocumentNoCaptionLbl, "Sales Header"."Document Type"))
                    {
                    }
                    ...
                    column(Amount_SalesInvHeader; "Sales Header".Amount)
                    {
                    }
                    column(AmountIncludingVAT_SalesInvHeader; "Sales Header"."Amount Including VAT")
                    {
                    }
                    column(InvoiceDiscountAmount_SalesInvHeader; "Sales Header"."Invoice Discount Amount")
                    {
                    }
                    column(YourReference_SalesInvHeader; "Sales Header"."Your Reference")
                    {
                    }
            ...
            begin
                ...
                FOR i := 1 TO 4 DO BEGIN
                    IF i = 1 THEN
                        CustDate[i] := CALCDATE('<CD-4M>', "Sales Header"."Posting Date")
                    ELSE
                ...
                tempdata[1] := "Sales Header"."Sell-to Customer Name";
                tempdata[2] := "Sales Header"."Sell-to Customer Name 2";
                tempdata[3] := "Sales Header"."Sell-to Contact";
                ...
                //restore data
                "Sales Header"."Sell-to Customer Name" := tempdata[1];
                "Sales Header"."Sell-to Customer Name 2" := tempdata[2];
                "Sales Header"."Sell-to Contact" := tempdata[3];
